...
const Dashboard: NextPageWithLayout = () => {
  const [dangerColor, setDangerColor] = useState<string>('rgba(255, 255, 255, 0)')
  const [infoColor, setInfoColor] = useState<string>('rgba(255, 255, 255, 0)')
  const [infoColorRgb, setInfoColorRgb] = useState<string>('255, 255, 255')
  const [successColor, setSuccessColor] = useState<string>('rgba(255, 255, 255, 0)')

  useEffect(() => {
    setDangerColor(getStyle('--cui-danger'))
    setInfoColor(getStyle('--cui-info'))
    setInfoColorRgb(getStyle('--cui-info-rgb'))
    setSuccessColor(getStyle('--cui-success'))
  }, [])
  ...
  const tableExample = [
    ...
    {
      avatar: { src: avatar2.src, status: 'danger' },
      user: {
        name: 'Avram Tarasios',
        new: false,
        registered: 'Jan 1, 2021',
    ...
    {
      avatar: { src: avatar3.src, status: 'warning' },
    ...
    {
      avatar: { src: avatar4.src, status: 'secondary' },
    ...
    {
      avatar: { src: avatar6.src, status: 'danger' },
      user: {
        name: 'Friderik Dávid',
        new: true,
        registered: 'Jan 1, 2021',
